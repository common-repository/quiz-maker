...
class AYS_Quiz_Questions{
        ...
        public function ays_quiz_questions_display_list(){
            include_once AYS_DIR.'/classes/AYS_Quiz_Questions_List_Tables.php';
                            ...
                            <table class="answers_table" id="answers_table" width="100%">
                                <tbody class="answers_tbody"  id="answers_tbody" >
                                    <tr>
                                            ...
                                            <th class="ays_center" width="4%"><img src="<?php echo AYS_URL.'/includes/images/add_option.png'; ?>" onclick="add_option('radio')"/></th>		
                                    </tr>
                                    <?php
                                    $ays_correctss = array();
                                    foreach($ays_quiz_mets_answers as $k=>$poqr_answers)
                                    {
                                        ...
                                        echo    '<tr id="single_ques_'.$k.'" class="answers">
                                                        ...
                                                        <td class="move_answer">
                                                            <img src="'.AYS_URL.'/includes/images/cursor.png" />
                                                        </td>
                                                        <td>
                                                            <input type="'.$ays_quiz_nk_type.'" name="correct" '.$ishmarForJisht.' class="correct" value="'.($k+1).'" onclick="refresh_correct()"/>		
                                                        </td>
                                                        ...
                                                        <td>
                                                            <img src="'.AYS_URL.'/includes/images/delete_option.png" onclick="delete_option(\'single_ques_'.$k.'\')"/>
                                                        </td>
                                                        <td>
                                                        </td>
                                                </tr>
    ...
    <script>
        ...
        function add_option(type)
        {
            ...
            img1.setAttribute("src", "<?php echo AYS_URL.'/includes/images/cursor.png';?>");
            ...
            img4.setAttribute("src", "<?php echo AYS_URL.'/includes/images/delete_option.png';?>");	
        ...
        {
            correct = '';
            answer_count = $('.correct').length;
            $('.correct').each(function(index) {
                    correct += ($(this).prop('checked') ? 1 : 0);
                    if(index != answer_count-1)
                            correct +=',';
            });

            $('#correct_values').val(correct);
        }    
    </script>
    <?php
