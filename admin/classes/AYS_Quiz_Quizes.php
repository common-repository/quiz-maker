...
class AYS_Quiz_Quizes{
    ...
    function ays_quiz_display_list(){
        include_once AYS_DIR.'/classes/AYS_Quiz_Quizes_List_Tables.php';
                                ...
                                <tbody class="sel_question"  id="sel_question" >
                                    ...
                                    <?php
                                        ...
                                        foreach ($ays_questions_results as $ays_results){
                                            ...
                                            . "<td class='move_question'><img src='".AYS_URL."/includes/images/cursor.png' /></td>"
                                            . "<td>".$ays_results->question."</td>"
                                            . "<td>".$ays_question_category_row->title."</td>"
                                            . "<td>".$ays_results->type."</td>"
                                            . "<td>".$ays_results->id."</td>"
                                            . "<td><img src='".AYS_URL."/includes/images/delete_option.png' style='cursor:pointer;'  onclick='delete_option(\"ays_all_questions_".$ays_results->id."\",".$ays_results->id.")'/></td>"
                                            ."</tr>";
                                        }
                                    ?>
                                    <script>
